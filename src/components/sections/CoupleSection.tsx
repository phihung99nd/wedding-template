...
export function CoupleSection({
  ...
  bride = {
    ...
    birthday: "Birthday",
    description:
      "Enim dolor lorem amet ex ex laboris labore. Culpa elit dolor tempor cillum aliqua tempor. Ullamco sint irure id nisi enim fugiat aliquip non commodo irure. Pariatur labore consequat aute non nostrud voluptate. Labore dolor tempor sunt consectetur excepteur voluptate enim...",
    avatar:
  ...
  groom = {
    ...
    birthday: "Birthday",
    description:
      "Esse ullamco sint velit non lorem cillum elit pariatur ex do exercitation. Aliquip irure pariatur tempor aute. Quis adipiscing dolor tempor veniam proident lorem anim magna do enim. Laborum magna nostrud id fugiat ullamco reprehenderit veniam culpa. Proident eiusmod ipsum non irure...",
    avatar:
    ...
    >
      <div className="container mx-auto max-w-6xl">
        <AnimatePresence>
          ...
          {/* Couple Info */}
          <div
            className="relative flex items-center justify-center gap-8 flex-wrap"
            ...
            >
              <div className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-[40px] mb-2 font-imperial">
                    {groom.name}
                  </h3>
